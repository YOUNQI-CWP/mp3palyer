...
int choice = 1; //演示模式选择。
const char* audioPath = "./audio.mp3"; // 修改: 将文件名后缀改为 .mp3

/*************************************SDK初始化参数**********************************************************/
const char *APPID     = "894244c6";                             // 用户的APPID
const char *APIKEY    = "97fc61dbeea347213ec7db4d37e15e46";    // 用户的APIKey
const char *APISECRET = "YjgwZWMzM2M2NGI2OWVmZDY0MmNiMjFk"; // 用户的APISecret
